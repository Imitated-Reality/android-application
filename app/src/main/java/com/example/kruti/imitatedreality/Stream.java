...
public class Stream extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardboardView = (GvrView) findViewById(R.id.fullscreen_content);
        cardboardView.setRenderer((GvrView.StereoRenderer) this);
    ...
    public void changeActivity1()
    {
        ...
        {
            Intent intent1=new Intent(Stream.this,StartStreaming.class);
